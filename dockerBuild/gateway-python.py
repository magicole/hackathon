...
sensor_endpoint2 = os.environ['SENSOR_ENDPOINT2']
...
sensor_socket2 = 'ws://' + sensor_endpoint2 +'/ws'
sensor_data = ''
...
while True:
	...
	ws2 = websocket.create_connection(sensor_socket2)
        break
...
while True:
    ...
    result2 = ws2.recv()
    sensor_data = result
    sensor_data2 = result2
    
    avg = (sensor_data + sensor_data2)/2
